    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1"> Edit Company Data </h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}"
                                    class="text-muted">Dashboard</a></li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Edit Company Data</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                            ...
                                            <div class="col-12 col-lg-12 col-xl-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <i class="fa fa-table" aria-hidden="true"></i>Edit  Company Data 
                                                    </div>
                                                        ...
                                                        <div class="needs-validation">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="tel" name="company_website" value="{{$company->company_website}}"
                                                                        class="form-control" required="">
                                                                </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <img id="image-target" src="{{asset('storage/'.$company->company_logo)}}" style="height:100px;width:150px;cursor:pointer;">
                                                                    @else
                                                                    <img id="image-target" src="{{asset('no_image.png')}}" style="height:100px;width:150px;cursor:pointer;">
                                                                    @endif
...
<script>
    ...
    $("#form").submit(function() {
        ...
        axios.put("{{ route('companies.update',$company->company_id) }}", new FormData($("#form")[0])).then(response => {
            console.log(response);
            var data = response.data;
            if (data.success) notify(null, 'Company Update successfully', 'top right', 'success', true,
